...
Steam Multi Runtime `0.12.1`では、公開汎用パッケージとして`com.koiusa.application` 0.2.0、`com.koiusa.input.core` 0.2.0、`com.koiusa.input.icons` 0.1.1、`com.koiusa.keyconfig` 0.2.0、`com.koiusa.inputguide` 0.1.0を同梱します。
