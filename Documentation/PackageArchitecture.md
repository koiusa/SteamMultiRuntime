...
Steam Multi Runtimeは、公開汎用パッケージとして`com.koiusa.application`、`com.koiusa.input.core`、`com.koiusa.input.icons`、`com.koiusa.keyconfig`、`com.koiusa.inputguide`を同梱します。現在バージョンと依存条件の正本は各パッケージの`package.json`です。
