...
- Input Guide observes Input Action changes only while its UI Toolkit root is attached to a Panel; Panel detachment cancels deferred binding refreshes before navigation leases are released during Play Mode teardown.
