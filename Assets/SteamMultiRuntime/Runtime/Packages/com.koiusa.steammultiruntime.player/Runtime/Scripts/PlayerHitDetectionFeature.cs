...
namespace Koiusa.SteamMultiRuntime
{
    ...
    public sealed class PlayerHitDetectionFeature : MonoBehaviour
    {
        private readonly Collider[] hits = new Collider[32];
        private readonly HashSet<IPlayerDamageReceiverFeature> damaged = new HashSet<IPlayerDamageReceiverFeature>();
        ...
        public int PerformAreaAttack(GameObject source, Vector3 center, float radius, float damage, Vector3 direction, LayerMask layers)
        {
            ...
            {
                var receiver = hits[i] != null ? hits[i].GetComponentInParent<IPlayerDamageReceiverFeature>() : null;
                ...
                receiver.ReceiveDamage(new PlayerDamageRequest(source, damage, center, direction));
            }
