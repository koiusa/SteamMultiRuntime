...
using Unity.Netcode;
using UnityEngine;
using Koiusa.SteamMultiRuntime.Network.Lobby;
...
namespace Koiusa.SteamMultiRuntime
{
    internal class SteamLobbyQualityTracker
    {
        ...
        private LobbyNetworkSessionController networkFacade;
        ...
        public void Initialize(LobbyNetworkSessionController facade, bool useAdditiveClientSynchronization)
        {
