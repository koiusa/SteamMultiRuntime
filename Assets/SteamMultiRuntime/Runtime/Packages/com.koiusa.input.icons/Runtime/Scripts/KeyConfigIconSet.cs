...
namespace Koiusa.Input.Icons
{
    [CreateAssetMenu(fileName = "KeyConfigIconSet", menuName = "Koiusa/Keyconfig/Input Binding Icon Resolver", order = 100)]
    public sealed class KeyConfigIconSet : ScriptableObject
    {
        [Serializable]
        internal struct CustomIconBinding
        {
        ...
        internal IReadOnlyList<CustomIconBinding> CustomBindings => customBindings;
        ...
        internal void SetCustomBindingIcon(string deviceType, string controlName, Texture2D icon)
        {
        ...
        internal Texture2D ResolveDisplayIcon(string deviceType, string controlName, string bindingPath)
        {
