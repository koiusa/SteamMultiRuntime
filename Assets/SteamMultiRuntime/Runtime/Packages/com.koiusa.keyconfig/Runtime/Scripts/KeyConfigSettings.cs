...
{
    [CreateAssetMenu(fileName = "KeyConfigSettings", menuName = "Koiusa/Keyconfig/Input Actions Config", order = 101)]
    public sealed class KeyConfigSettings : ScriptableObject
    {
