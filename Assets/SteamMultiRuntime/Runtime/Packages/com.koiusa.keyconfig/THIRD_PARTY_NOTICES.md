...
## Free Super Input Prompt Icon Pack

The input prompt icons under `Runtime/Resources/Icons` are derived from the
Free Super Input Prompt Icon Pack by JulioCacko.

- Source: https://juliocacko.itch.io/free-super-input-prompt-pack-icons-unreal-unity-godot
